...
('ec001','game over','1-2','../assets/PC-Burn.png','Retour page d’accueil','Ça la chatouille et dans son geste elle vous broie. Vous êtes supprimé. L’appli est crashée. GAME OVER','Home'),
('ec002','turn back','3-3','../assets/scene_LaboFigma.png','Retour au code source','Votre pied s’enfonce encore plus dans la mélasse et vous vous étalez de tout votre long ! Retour case départ','sc002'),
('ec003','turn back','4-1','../assets/scene_LaboFigma.png','Retour au code source','Ça n’a aucun effet sur elle, elle vous bloque le passage et vous êtes obligé de rebrousser chemin.','sc002'),
('ec004','game over','5-1','../assets/PC-Burn.png','Retour page d’accueil','Ils url de colère et vous ra-get toutes vos possessions. Dépouillé.e, vous ne pouvez plus rien faire et votre mission s’arrête ici. L’appli est crashée. GAME OVER','Home'),
('ec005','transition','5-2','../assets/scene_LaboFigma.png','Suite','Judicieuse décision, leur traffic est stable et vous ne voulez pas les déranger.','sc007'),
('ec006','transition','3-1','../assets/scene_LaboFigma.png','Suite','Le charabia y est sensible ! Fini le combat, vous vous étreignez et allez à la ligne suivante','sc006'),
('ec007','turn back','6-2','../assets/scene_LaboFigma.png','Retour au code source','Quelle erreur ! Vous venez de séparer 2 amoureux secrets ! Tout le code s’écroule et il va falloir tout refaire… Retour case départ.','sc002'),
('ec008','game over','7-2','../assets/PC-Burn.png','Retour page d’accueil','Quelle grossièreté ! Votre mauvaise humeur ne vous amènera nulle part. Vous êtes exclu.e de la mission. GAME OVER','Home'),
('ec009','transition','4-2','../assets/scene_LaboFigma.png','Suite','Bravo ! La variable est domptée et prête à être votre alliée. Poursuivez votre aventure.','ec013'),
('ec010','transition','6-1','../assets/scene_LaboFigma.png','Suite','Vous avez tout compris ! Vous avez eu l’oeil en voyant gravé en bas du tableau « XML » : car oui ! X aime L, Xavier est amoureux de Lisa et il s’avère qu’elle aussi mais ces 2 nigauds ne se parlent pas. Rien qu’un gros câlin ne puisse régler.','sc008'),
('ec011','turn back','8-2','../assets/scene_LaboFigma.png','Retour au code source','Hook vous arrête et vous crash à la figure. Tout le code s’écroule et vous êtes obligé de repartir du début','sc002'),
('ec012','transition','8-1','../assets/scene_LaboFigma.png','Suite','Bravo ! Hook se calme et se met à l’écoute de son état intérieur. Stabilisé, il vous guide vers la suite.','ec013'),
('ec013','transition','10-1','../assets/scene_LaboFigma.png','Suite','Bravo ! Vous avez stabilisé le code ! Il ne vous reste plus qu’à le déployer à la place de l’autre, toujours bloqué par la dévastatrice code-erreur.','sc011'),
('ec014','transition','10-2','../assets/scene_LaboFigma.png','Suite','Bien joué, vous avez trouvé comment régler ces problèmes là, mais avez-vous bien fait le tour de TOUS les problèmes ?','sc002');
